...
Console scripts:
  openbeats-tokenize  (tokenize_main)  -- dump codes for a manifest of audio
  openbeats-tokens    (tokens_main)    -- inspect / stats / validate a dataset

Heavy imports (torch, the tokenizer) are deferred into the functions so ``--help``
stays fast, matching openbeats.cli.
"""
